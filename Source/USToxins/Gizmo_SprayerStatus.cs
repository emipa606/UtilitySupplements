...
namespace USToxins
{
	...
	internal class Gizmo_SprayerStatus : Gizmo
	{
		...
		public override GizmoResult GizmoOnGUI(Vector2 topLeft, float maxWidth)
		{
			...
			float fillPercent = (float)(this.Sprayer as USToxUsesData).USToxUses / (float)(this.Sprayer as USToxUsesData).ToxUses.Props.USToxUses;
			Widgets.FillableBar(rect3, fillPercent, Gizmo_SprayerStatus.FullBarTex, Gizmo_SprayerStatus.EmptyBarTex, false);
			Text.Font = GameFont.Small;
			Text.Anchor = TextAnchor.MiddleCenter;
			Widgets.Label(rect3, (this.Sprayer as USToxUsesData).USToxUses.ToString("F0") + " / " + (this.Sprayer as USToxUsesData).ToxUses.Props.USToxUses.ToString("F0"));
