...
namespace USToxins
{
	...
	internal class Globals
	{
		...
		{
			string defName = filthdef.defName;
		...
		internal static DamageDef USPlantToxin = DefDatabase<DamageDef>.GetNamed("Dam_USPlantToxin", true);

		// Token: 0x04000023 RID: 35
		internal static HediffDef USStinkRootGas = DefDatabase<HediffDef>.GetNamed("HED_USStinkRootGas", true);

		// Token: 0x04000024 RID: 36
		internal static ThingDef USStinkyGas = DefDatabase<ThingDef>.GetNamed("Gas_USStinkroot", true);

		// Token: 0x04000025 RID: 37
		internal static HediffDef USTangleRootStrike = DefDatabase<HediffDef>.GetNamed("HED_USTangleRoot", true);

		// Token: 0x04000026 RID: 38
		internal static ThingDef USTangleGas = DefDatabase<ThingDef>.GetNamed("Gas_USTangleroot", true);

		// Token: 0x04000027 RID: 39
		internal static ThingDef USTanglePlant = DefDatabase<ThingDef>.GetNamed("Plant_USTangleroot", true);

		// Token: 0x04000028 RID: 40
		internal static float USTanglePlantFertMin = Globals.USTanglePlant.plant.fertilityMin;

		// Token: 0x04000029 RID: 41
		internal static HediffDef USTearGas = DefDatabase<HediffDef>.GetNamed("HED_USTearGas", true);

		// Token: 0x0400002A RID: 42
		internal static HediffDef USAcidGasEffect = DefDatabase<HediffDef>.GetNamed("HED_USAcidGas", true);
	}
}
