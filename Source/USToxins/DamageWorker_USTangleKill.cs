...
namespace USToxins
{
	...
	public class DamageWorker_USTangleKill : DamageWorker
	{
		...
		public override DamageWorker.DamageResult Apply(DamageInfo dinfo, Thing victim)
		{
			...
			if (victim.def.category == ThingCategory.Pawn && (victim as Pawn).RaceProps.FleshType.defName != "Insectoid" && !(victim as Pawn).RaceProps.IsMechanoid && victim.def.useHitPoints && dinfo.Def.harmsHealth)
			{
